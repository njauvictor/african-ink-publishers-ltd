...
const SingleBookContent = ({ book, isLoading, error }) => {
  ...
  const { cartItems, addItem, updateQuantity } = useCartStore(); // Use Zustand store
  ...
  return (
    <div className="mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 py-8 bg-primary-dark/5">
      <div className="max-w-6xl mx-auto rounded-lg overflow-hidden bg-white dark:bg-gray-800 shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 md:pt-8">
                ...
                >
                  ...
                  Buy & Read Ebook: KES {book.ebook_price}
                </button>
                ...
                <Link href={`/audio/${book.id}`}>
                  <button              
                    ...
                    Buy & Listen to Audiobook: KES {book.audio_price}
                  </button>
                </Link>
                ...
                >
                  ...
                  Buy Physical Book: KES {book.book_price}
                </button>
              </div>
